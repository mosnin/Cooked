    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          disabled={!isOwner}
        />
        <p className={CAPTION}>Optional. Shown on your team profile.</p>
      </div>
      ...
      <div className="space-y-3 pt-3">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-0.5">
            ...
            <p className={CAPTION}>Shown on intake pages for reps under your team.</p>
          </div>
          {isOwner && (
            <button
              type="button"
              onClick={() => {
                setPrivacyPolicyHtml(generatePrivacyPolicy(name, 'team'));
        ...
        <RichTextEditor
          ...
          placeholder="Enter your team privacy policy here or click 'Generate template' to start..."
          disabled={!isOwner}
        />
        <p className={CAPTION}>
