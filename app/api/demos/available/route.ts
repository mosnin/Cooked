...
export async function GET(req: NextRequest) {
  ...
  // rep's GCal quota (~1k free-tier ops/day burnt in minutes by 100
  ...
  // Fetch existing demos in range (filter by property if specified)
  ...
  if (propertyId) {
    demosQuery = demosQuery.eq('propertyProfileId', propertyId);
  }
