-- ============================================================================
-- Purge the legacy manager-Koala rows from the shared rep chat tables.
--
-- The deferred follow-up to 20260616000000_manager_chat_separate_storage.sql.
-- That migration copied every '[MANAGER_KOALA] <teamId>' conversation (and
-- its messages) into the structurally-isolated "ManagerConversation" /
-- "ManagerMessage" tables, keyed by teamId, but intentionally did NOT delete
...
--
-- DELIBERATELY OUT OF SCOPE: team chat ('[TEAM_CHAT]%'). That surface has
...
-- the rep surface keeps hiding them via the reserved-title guards.
-- ============================================================================
