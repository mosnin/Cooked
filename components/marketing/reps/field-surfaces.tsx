...
/**
 * FieldSurfaces — the "reach Koala wherever the work is" row for /reps.
 *
 ...
 * one icon, one line). The idea: a solo rep is rarely at a desk; Koala is
...
const SURFACES = [
  {
    icon: Smartphone,
    title: 'on your phone.',
    body: 'talk to Koala between showings. read the thread, approve the draft, book the demo without sitting down.',
  },
  {
    icon: Globe,
