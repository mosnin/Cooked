...
export function DemosClient({ slug, spaceId, initialDemos, hasGoogleCalendar, bookingUrl, propertyProfiles: initialProfiles = [], demoSettings: initialDemoSettings }: DemosClientProps) {
                      ...
                      >
                        ...
                        <td className="px-4 py-3 hidden md:table-cell text-xs text-muted-foreground">
                          {demo.propertyAddress ? (
                            <span className="flex items-center gap-1"><MapPin size={10} /> {demo.propertyAddress}</span>
                          ) : '—'}
                        </td>
                        <td className="px-4 py-3">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0 space-y-1">
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
                      ...
                      {demo.propertyAddress && <span className="flex items-center gap-1"><MapPin size={11} /> {demo.propertyAddress}</span>}
                    </div>
                    {demo.notes && (
