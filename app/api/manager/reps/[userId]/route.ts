 ...
 * Returns a rep's contacts, deals, and stats for the manager drill-down view.
 * Only returns data if the user is a member of the manager's team.
 */
export async function GET(_req: Request, { params }: Params) {
  ...
  // Verify this user is a member of the manager's team
