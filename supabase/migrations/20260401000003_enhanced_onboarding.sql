-- Enhanced onboarding fields for reps and managers

-- Rep profile fields on User table
ALTER TABLE "User"
  ...
  ADD COLUMN IF NOT EXISTS "teamAffiliation" text,
...
ALTER TABLE "Team"
  ...
  ADD COLUMN IF NOT EXISTS "teamType" text
    CHECK ("teamType" IN ('independent', 'franchise', 'virtual')),
