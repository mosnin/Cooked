...
const METHOD_OPTIONS: Array<{
...
}> = [
  {
    value: 'round_robin',
    label: 'Round-robin',
    helper: 'Distribute leads evenly across active reps in rotation.',
  },
  {
    value: 'score_based',
    label: 'Score-based',
    helper: 'Send each lead to the rep with the highest score and availability.',
  },
  {
    value: 'manual',
    label: 'Manual only',
          ...
          <section className="space-y-5">
            ...
            <div className="flex items-start justify-between gap-4 py-3 border-b border-border/60">
              <div className="space-y-0.5">
                ...
                <p className={CAPTION}>
                  Send new leads to a rep automatically. Off means they sit in the inbox.
                </p>
              </div>
            ...
            <div className="pt-6 space-y-5 border-t border-border/60">
              ...
              <div className="flex items-start justify-between gap-4 py-3 border-b border-border/60">
                <div className="space-y-0.5">
                  ...
                  <p className={CAPTION}>
                    Hold reps to a first-response time. Koala nudges them, then escalates to you if a lead stays cold.
                  </p>
                </div>
