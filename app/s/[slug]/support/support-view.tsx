 ...
 *
 * One intent: a rep submits a support request. The form is the focal
 * element; the rep's own past tickets sit below it with status badges.
 *
 ...
 * rep has to operate — just say what's wrong and send it.
 */
