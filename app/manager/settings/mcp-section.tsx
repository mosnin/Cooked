...
/**
 * TeamMcpSection — MCP endpoint + API keys for team-scoped access.
 * Same vocabulary as the rep McpSection: hairline inputs, divide-y key
 * list, PRIMARY_PILL submit. The endpoint is shared; keys are scoped to the
 * team owner's space.
 */
export function TeamMcpSection({ slug }: TeamMcpSectionProps) {
    ...
    <div className="space-y-10">
      ...
      <div className="space-y-5">
        <div className="space-y-1.5">
          ...
          <p className={CAPTION}>Streamable HTTP transport. Scoped to your team.</p>
        </div>
      ...
      "headers": {
        "Authorization": "Bearer YOUR_API_KEY"
          ...
          <p className={CAPTION}>
            ...
            every lead and deal in the team.
          </p>
        </div>
      </div>
      ...
      >
        ...
        {newCreds && (
          <div className="rounded-md border border-border/70 bg-foreground/[0.02] p-4 space-y-3">
            <div className="flex items-center justify-between">
              <p className={H3}>Your team MCP credentials</p>
              <button
                type="button"
        ...
        {showForm && !newCreds && (
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <Input
                id="team-mcp-key-name"
                value={newKeyName}
                onChange={(e) => setNewKeyName(e.target.value)}
                placeholder='e.g. "Claude Desktop — Team"'
                className="flex-1"
              />
              <button
                type="button"
