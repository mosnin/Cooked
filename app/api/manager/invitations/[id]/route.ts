...
export async function PATCH(_req: Request, { params }: Params) {
  ...
  // Scope the update to teamId as well to prevent a TOCTOU race between
  ...
  void audit({ actorClerkId: clerkId ?? null, action: 'UPDATE', resource: 'Invitation', resourceId: invitationId, metadata: { status: 'cancelled', teamId: ctx.team.id } });
