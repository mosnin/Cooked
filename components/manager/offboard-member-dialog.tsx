        ...
        {state === 'choose' && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Pick which active member should receive this agent&apos;s team
          ...
          <>
            ...
            {nothingToTransfer ? (
              <div className="rounded-lg border border-border bg-muted/40 px-4 py-3 text-sm text-muted-foreground">
                Nothing to transfer &mdash; this agent has no team-owned data.
              </div>
            ) : (
              <div className="rounded-lg border border-border bg-card p-4 space-y-2">
                <p className="text-sm">
                  <span className="font-semibold tabular-nums">{preview.contactCount}</span>{' '}
                  team {preview.contactCount === 1 ? 'contact' : 'contacts'} will move
                  to{' '}
