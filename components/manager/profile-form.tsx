 ...
 * team. Mirror of the rep profile-section (display name, title, bio,
 * photo, phone) but persisted per-member on TeamMembership via
    ...
    <form onSubmit={handleSave} className="space-y-8">
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="A short bio shown alongside your name in the team."
          rows={3}
        />
      </div>
