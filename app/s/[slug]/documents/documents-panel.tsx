...
/**
 * DocumentsPanel — list + editor for the rep's own documents.
 *
 * A document is a file the rep authored in-app. Two modes, swapped in
 * place (no routing): a divide-y list of documents, and an editor for
 * one. Koala can read and attach these, but the rep is always the
...
export function DocumentsPanel() {
  ...
  // for existing docs (the rep opens to read), edit by default for
  // new ones (the rep opens to write).
    ...
    return (
      <div className="space-y-5">
        ...
        {editorMode === 'edit' ? (
          ...
          // surface so the rep can tell at a glance whether they're
          // viewing or editing.
...
/** When the rep lands in Preview mode with empty content, show a calm
