-- Extend AIUserProfile with the fields captured by the new rep onboarding:
--   role          — solo agent / team lead / team owner
--   zipCode       — primary market ZIP, used by Koala for market context
--   leadSources   — channels the rep uses to acquire leads (linkedin, outbound, events, …)
--
