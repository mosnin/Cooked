...
describe('POST /api/axil/post-demo', () => {
  ...
  it('forwards a contextHint with personId/dealId to the orchestrator', async () => {
    // Surfaces the URL-driven pre-fill — when the rep opens the recorder
  ...
  it('forwards integration tools to the orchestrator when the rep has connected apps', async () => {
