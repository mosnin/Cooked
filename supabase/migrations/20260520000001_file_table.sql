...
-- This is the user-facing "Files" page surface — anything the rep
...
-- Hot path: rep's Files page query → spaceId + recency.
...
-- Per-user quota query for teams (multiple reps share a Space).
