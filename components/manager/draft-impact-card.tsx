...
/**
 * "Draft impact" — single card on the manager dashboard. Reports how Koala's
 * drafts landed across the team over the trailing 30 days.
 *
...
function DraftImpactBody({ stats }: { stats: DraftStats }) {
  ...
  // nothing for the manager to misread as "Koala is broken."
  if (stats.total === 0) {
    return (
