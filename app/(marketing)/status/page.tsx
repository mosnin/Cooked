 ...
 * surfaces a rep depends on, each carrying a single dot.
 *
 ...
 * The per-user, per-workspace health (a rep's own Gmail/Calendar
 ...
 * health (this rep's Gmail token) is auth-gated and not shown here.
 */
