 ...
 *
 * All four surfaces are the rep's storefront for a stranger. On
 * desktop they should feel like one product family: a centred card
 * floating over a heavy-blurred image fill (the rep's cover photo or
...
export interface PublicSurfaceFrameProps {
  /** Image that fills the desktop blur canvas. Usually the rep's
   ...
   *  document state — applicants see whatever the rep branded for. */
  darkMode?: boolean;
