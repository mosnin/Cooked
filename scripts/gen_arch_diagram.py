...
draw_band(c, "Surfaces", "browser + MCP clients", [
    "Marketing site (logged-out)", "Clerk auth · rep/manager login",
    "Rep workspace  /s/[slug]", "Manager dashboard  /manager",
...
draw_band(c, "Next.js API", "312 endpoints (App Router)", [
    ...
    "pipelines", "demos", "properties", "calendar", "studio", "manager (44)",
    "teams", "billing", "integrations", "clients", "applications", "calls",
...
draw_band(c, "Core services", "lib/*", [
    ...
    "team-routing", "commissions", "team-seats", "billing (Stripe)",
...
draw_band(c, "Modal sandbox", "agent/* (Python, autonomous + swarm)", [
    ...
    "koala.py + modules · 53 tools", "koala_manager.py  (chief-of-staff)",
...
draw_band(c, "Data stores", "source of truth", [
    ...
    "User · Space · SpaceSetting · Team · Membership",
    "Contact · Deal · DealStage · Demo · Property",
...
svg.append(f'<text x="{PAD+2}" y="{PAD+52}" font-family="{FONT}" font-size="13.5" '
           f'fill="#6b7280">Agentic OS for reps &amp; teams · Next.js 15 / React 19 · '
