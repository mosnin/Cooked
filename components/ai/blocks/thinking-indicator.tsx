...
/**
 * Thinking indicator shown while Axil is mid-turn.
 *
 * The whole indicator is one alive line: the current action text shimmers
 * through `axil-thinking-shimmer`, transitions smoothly when the action
        ...
        <AnimatePresence mode="wait" initial={false}>
          {action && (
            <motion.span
              ...
              className="axil-thinking-shimmer text-[13px] font-medium leading-relaxed"
            >
              {action}
            </motion.span>
          )}
