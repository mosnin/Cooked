...
/**
 * POST /api/contacts/[id]/info-request — rep asks a client to send
 ...
 *
 * Rep auth via requireContactAccess (the protected-system pattern) — the
 * rep must own the space the contact belongs to.
 */
