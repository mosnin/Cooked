...
// team, then hand off to the client for filter/pagination. Mirrors the
...
export default async function ManagerActivityPage() {
  ...
  //    team-tagged null-space rows, merged and trimmed. See the route
    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      <header className="space-y-1.5">
        ...
        <p className="text-sm text-muted-foreground">
          Every action across your team, newest first.
        </p>
      </header>
      <ActivityClient
