...
-- checkpoint: the rep asked Koala to do something, a tool needs approval,
...
-- when the rep decides. Schema-versioned by the SDK itself
...
--
-- The approvals JSONB is the rep-facing prompt list — `ApprovalPrompt[]`
...
CREATE TABLE IF NOT EXISTS "AgentPausedRun" (
  ...
  -- Clerk userId of the rep whose chat is paused. Not a Space-scoped
...
-- Per-user filter for sessions where multiple reps share a Space.
