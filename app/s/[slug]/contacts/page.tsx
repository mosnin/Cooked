...
/**
 * Read-only fetch of the rep's own deals + stages for the performance
 ...
 * the rep's overall output, not a single pipeline. Never writes.
 *
...
export default async function ContactsPage({
  ...
  // of the "messy top" the rep flagged.
  //
