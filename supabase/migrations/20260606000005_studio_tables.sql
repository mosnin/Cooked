...
--
--   StudioBrand      — the rep's brand kit (one row per Space). Logo and
...
CREATE TABLE IF NOT EXISTS "StudioGeneration" (
  ...
  -- Authoritative dollar cost of this generation. Summed into rep usage
