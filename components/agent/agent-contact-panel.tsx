...
import { AxilAssessmentCard } from '@/components/agent/axil-assessment-card';
  ...
  if (loading) {
    return (
      <div className="space-y-3">
        <AxilAssessmentCard entityType="contact" entityId={contactId} entityName={contactName ?? 'this contact'} slug={slug} />
  ...
  return (
    ...
    <div className="rounded-lg border border-border/70 bg-card overflow-hidden">
      <div className="px-4 py-3 border-b border-border flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          <Link
            href={`/s/${slug}/axil?q=${encodeURIComponent(`Tell me about ${contactName ?? 'this contact'} and suggest what I should do next`)}`}
