 ...
 * (`onboarding-rep-v2.tsx`). The legacy `onboarding-rep.tsx`
 * keeps its own inline copies on purpose: it's the live flow, slated
 * for deletion once V2 ships to all reps, and refactoring code
...
export type Role = 'solo' | 'team_lead' | 'team_owner';
