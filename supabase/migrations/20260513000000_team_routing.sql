-- ============================================================================
-- Team Lead Auto-Routing: Schema (Phase BP7a)
-- ============================================================================
...
-- This migration gives that setting a home on the Team row.
--
-- It also adds a single round-robin cursor column (lastAssignedUserId) so
-- the routing engine can distribute leads fairly across rep members
...
-- Nullable because no lead has been routed yet on a fresh team.
