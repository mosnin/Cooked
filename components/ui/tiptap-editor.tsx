 ...
 *     rep can tell at a glance whether they're viewing or editing.
 */
    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          // so the rep doesn't feel a layout jump when toggling.
  ...
  return (
    <div
      className={cn(
        ...
        // Read mode: subtle muted tint so the rep can tell at a glance
