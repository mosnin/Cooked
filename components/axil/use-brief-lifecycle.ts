...
/**
 * The brief is a moment, not a surface. It exists to wake the rep
 ...
 * rep doesn't lose the brief mid-read by accident.
 */
...
interface UseBriefLifecycleArgs {
  ...
  /** Manual collapse override — set true when the rep explicitly
...
export function formatProgress(
  ...
  // The receipt has to sound like a rep would talk about their
