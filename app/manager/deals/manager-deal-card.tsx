 ...
 * Manager kanban card.
 *
 * Mirrors the rep DealCard visual vocabulary exactly — same layout,
 * same serif value, same health dot, same days-in-stage line — with two
 * additions: a rep byline below the address, and no drag handle (the
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Focal value — serif Times, matches rep card */}
        {deal.value != null && (
          <p
        ...
        {/* Rep byline — the manager oversight addition */}
