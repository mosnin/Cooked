    ...
    <article className="space-y-10">
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          ...
          <p>2.4. If you register on behalf of a team or organization, you represent that you have authority to bind that entity to these Terms.</p>
          <p>2.5. You are responsible for all team members and agents you invite to your team account. Their use of the Service is governed by these Terms, and you remain responsible for their compliance.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          <p>5.1. With respect to Subscriber Data (including Applicant data collected through intake forms), the Subscriber is the <strong className="text-foreground">Data Controller</strong> and Koala is the <strong className="text-foreground">Data Processor</strong>. Reps and teams are responsible for how they use their own data.</p>
          ...
          <p>5.4. Applicants who submit data through intake forms agree to both Koala&apos;s <a href="/legal/privacy" className="underline hover:text-foreground">Privacy Policy</a> and the applicable Subscriber&apos;s (rep/team) privacy policy.</p>
      ...
      <section>
        ...
        <div className="mt-3 text-sm text-muted-foreground space-y-3 leading-6">
          <p>6.1. The Service, including all software, design, text, graphics, interfaces, and underlying technology, is the exclusive property of Koala Inc. and is protected by intellectual property laws.</p>
