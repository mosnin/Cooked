...
/**
 * The default surface — focus mode. One focal item at a time. The rep
 * lands on /axil and sees ONE thing waiting on them with Send / Edit /
 ...
 *
 * The rep signal said simplicity wins. This is more simplicity — five
...
export function TodayFeed({
  ...
  slug: string;
  /** True when the rep has done nothing yet — triggers day-one welcome. */
  isFresh?: boolean;
  firstName?: string;
