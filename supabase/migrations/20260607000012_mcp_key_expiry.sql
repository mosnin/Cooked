...
-- meant the attacker had read-only Composio-MCP access to the rep's
...
--     enough that reps who set-and-forget don't break their Claude
...
--     (e.g. now() + 1y) and notify reps. Not done here — that's a
