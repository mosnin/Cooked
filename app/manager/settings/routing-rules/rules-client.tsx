            ...
            <div className="space-y-2">
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <div>
                  ...
                  <p className={CAPTION}>
                    Uses the rep pool. Tag narrowing is ignored until the membership tags column ships.
                  </p>
                </div>
              </label>
            </div>
            ...
            {form.destinationKind === 'agent' ? (
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <SelectContent>
                    {members.length === 0 ? (
                      <div className={cn(CAPTION, 'px-3 py-2')}>No team members yet.</div>
                    ) : (
                      members.map((m) => (
                        <SelectItem key={m.userId} value={m.userId}>
                          {m.name ?? m.email}
                          {m.role !== 'rep_member' ? ` · ${roleLabel(m.role)}` : ''}
                        </SelectItem>
                      ))
                    )}
                  </SelectContent>
