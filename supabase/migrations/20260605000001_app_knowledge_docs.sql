...
-- on demand when reps ask "how do I..." or "why isn't X working".
...
'Demos are property viewings scheduled for a contact at a specific time.
To book a demo, tell Koala "book a demo for [contact name] on [date] at [time]" — the contact must have an email address on file.
Demos appear on the Calendar page. Each demo record has a status: scheduled, completed, or cancelled.
After a demo completes, Koala can automatically follow up with the contact.
To view demos, go to the Calendar page in the sidebar.'),

('calendar', 'Calendar and events',
'The Calendar page shows all scheduled demos and follow-up dates.
Demos are automatically added to the calendar when booked via Koala or the demo booking flow.
...
'Koala requires the contact to have an email address to book a demo. If booking fails:
...
3. Provide a specific time: "book a demo for John on May 20 at 3pm" — vague times like "next week" will prompt Koala to ask for a specific time.'),
