...
/**
 * Generates a comprehensive privacy policy HTML template for reps and teams.
...
<ul>
  ...
  <li><strong>Communication:</strong> To contact you via email, SMS, or phone regarding properties, demos, applications, and follow-ups</li>
  ...
  <li><strong>Demo Scheduling:</strong> To book and manage property demos and appointments</li>
