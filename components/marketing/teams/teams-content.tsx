...
/**
 * TeamsContent — the body of `/teams`, composed entirely from the
 ...
 *   - empower the floor          → the rep's own Koala workspace (home)
 *   - lead routing / reassign    → lib/ai-tools/tools/assign-lead-to-rep.ts
 *   - performance rollups        → lib/ai-tools/tools/summarize-rep.ts
 ...
 *  one product. Primary → rep signup; secondary → /demo (prominent here,
 ...
 *  the other, alternating. Same rhythm as the home/reps pages. */
function FeatureRow({
  eyebrow,
  title,
  sub,
...
const EMPOWER = [
  {
    ...
    body: 'each rep keeps their own Koala workspace. it reads their inbox, drafts replies in their voice, and keeps every deal current. you add a team layer on top; you never take their workspace away.',
  },
  {
    icon: TimerReset,
  ...
  },
  {
    ...
    body: 'Koala drafts; the rep approves. every send goes through the person whose name is on it. the agent does the work; the floor stays in the driver’s seat.',
  },
];
    ...
    >
      <Reveal className="max-w-3xl">
        ...
        <p className="mt-4 max-w-xl text-lg leading-relaxed text-foreground/55">
          a team doesn&apos;t fail on features. it fails when the reps
 ...
 *  try-free-cta but keeps the team-flavored second option (Book a demo). */
function ClosingCta() {
  return (
    <section className="mx-auto max-w-7xl px-6 py-12 md:px-8 md:py-16">
      <Reveal>
        <div className="relative overflow-hidden rounded-[2rem] bg-[#171310] px-8 py-16 text-center md:px-16 md:py-24">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-xl text-lg text-white/55">
              the reps keep what they already do. the team sees what it
...
export function TeamsContent() {
  return (
    <>
      ...
      {/* Lead distribution — auto-assign and hand-pick to the right rep. */}
      <section
      ...
      >
        <FeatureRow
          ...
          title={<>every lead, the right rep.</>}
          sub="auto-assign by territory and load, or hand-pick the rep and write the brief. Koala can reassign a lead to anyone on the floor with a reason logged to the activity trail."
          points={[
            'auto-assignment, weighted by who has room.',
            'hand-pick and reassign, always your override.',
            'every assignment logged, with the reason, per rep.',
          ]}
      ...
      >
        <FeatureRow
          ...
          sub="ask Koala to roll up any rep's last week: deals active, won, and lost; new and hot leads; drafts pending and their approval rate. the numbers come from the work, not a status meeting."
          points={[
            'per-rep rollups across deals, leads, and drafts.',
        ...
        <Reveal className="mt-12 flex flex-wrap items-center gap-3">
          <span className="inline-flex items-center gap-2 text-[13px] text-foreground/55">
            ...
            grounded in the rep&apos;s real activity, every figure.
          </span>
        </Reveal>
      </section>
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
        <FeatureRow
          ...
          sub="approved templates the whole floor reaches for. Koala adapts each one to the lead and the rep's voice, so a template never lands as a stamp, and the high-risk replies stay on-brand."
          points={[
            'a team-wide library, written once.',
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
        <FeatureRow
          ...
          sub="three roles, no permissions matrix. Owner runs the show, Admin manages the floor, Member is the rep doing the work. admins see the rollup; private drafts and notes stay private."
          points={[
