 ...
 * that lay out the shell (sidebar, page container, FocusCard, AxilBar)
...
/** AxilBar (persistent floating composer) — `RHYTHM_U × 16`. */
...
/** AxilBar max width — 768px matches Tailwind's `max-w-3xl`, kept as
