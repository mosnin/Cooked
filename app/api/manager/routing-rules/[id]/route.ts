 ...
 * re-verifies the row belongs to the caller's team before writing,
...
export async function PATCH(req: NextRequest, { params }: Params): Promise<NextResponse> {
  ...
  // new target is still a member of THIS team.
  if (
    ...
    if (memErr) {
      logger.error(
        ...
        { ruleId, teamId: ctx.team.id, newUserId },
        memErr,
      );
