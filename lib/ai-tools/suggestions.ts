 ...
 *
 * Design intent (Jobs): the chips remove a typing step for the rep's
 ...
 * the rep would say them, not as commands.
 */
...
const SUGGESTIONS_BY_TOOL: Record<string, string[]> = {
  ...
  search_properties: ['Schedule a demo here', 'Find similar properties', 'Save this property'],
  find_property: ['Schedule a demo here', 'Find similar properties', 'Show recent comparables'],
  add_property: ['Schedule a demo', 'Match to interested buyers', 'Add another property'],
