...
re-broke it. Nobody noticed until the rep yelled.
...
- Ambiguous prompts firing tools instead of `ask_rep`
...
Or whenever a rep reports "Koala did the wrong thing." Add a case
...
{
  "id": "short-kebab-id",
  "prompt": "the exact rep utterance",
