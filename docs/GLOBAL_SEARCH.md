...
| **Demo** | `guestName`, `guestEmail`, `propertyAddress` | Guest name, property/date, status |
...
| Demos | `app/s/[slug]/demos/demos-client.tsx` | guest name, email, phone, property address, notes, linked contact |
