...
/**
 * The two closing payoff sections for /reps, kept together because they
 * answer the same buyer objection from two angles: "why move?" and "will it
 * fit how I work?"
 *
 *   1. OnePlace — the data-consolidation payoff. The rep stops bouncing
 ...
 *
 *   2. TailorIt — repetitive work handled, fit to the rep's existing
...
/** Repetitive work handled, fit to how the rep already works. */
const TAILORED = [
  {
    icon: PenLine,
