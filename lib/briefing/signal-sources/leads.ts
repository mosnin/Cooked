/**
 * Leads signal source — reads the rep's Contact rows for hot leads
 * that haven't been touched and overdue follow-ups.
 *
 * Team-routed contacts (teamId !== null) are excluded — those
 * are the team's queue, not on this rep's desk. Mirrors the
