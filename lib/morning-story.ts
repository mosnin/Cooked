 ...
 * and that intent rots if the rep goes quiet. New is just an arrival —
 ...
 *
 * `opts.skip` (default 0): with 47 hot leads, the rep would see the same
 ...
 * the rep can cycle to the next-best subject in one tap. skip=0 picks
