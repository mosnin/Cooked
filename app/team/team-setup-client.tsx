...
function CreateForm() {
  ...
  return (
    <form onSubmit={handleCreate} className="space-y-4">
      <div>
        <label className={cn(SECTION_LABEL, 'block mb-1.5')}>Team name</label>
        <input
          type="text"
          required
          placeholder="e.g. Preston Sales Group"
          value={name}
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-md text-center">
            ...
            <p className={cn(BODY_MUTED, 'mt-3')}>
              You&apos;re a member of{' '}
              <span className="font-medium text-foreground">{existingTeamName}</span>.
            </p>
        ...
        <div className="w-full max-w-4xl">
          ...
          <header className="mb-10 space-y-1.5">
            ...
            <p className={cn(BODY_MUTED, 'max-w-xl')}>
              Create your own team to manage a team of reps, or join one
          ...
          {mode === 'choose' && (
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <h2 className={cn(H3, 'mt-5 mb-2')}>Create a team</h2>
                <p className={cn(BODY_MUTED, 'leading-relaxed mb-5')}>
                  Start your own team. Invite reps to join, manage their
                  leads, and get team-wide visibility from a central manager
                  dashboard.
                </p>
                <div className="space-y-2 mb-6">
                  {[
                    { icon: Users, label: 'Invite reps via email or share code' },
                    { icon: BarChart3, label: 'Team-wide lead and pipeline analytics' },
                    { icon: Mail, label: 'Manage team invitations' },
                  ].map((f) => (
                ...
                <div className="flex items-center gap-1.5 text-sm font-medium text-foreground transition-all duration-150 group-hover:gap-2.5">
                  Create a team <ArrowRight size={14} strokeWidth={2} />
                </div>
              </button>
              ...
              >
                ...
                <h2 className={cn(H3, 'mt-5 mb-2')}>Join a team</h2>
                <p className={cn(BODY_MUTED, 'leading-relaxed mb-5')}>
          ...
          {mode === 'create' && (
            <div className="max-w-md">
              ...
              <div className="rounded-xl border border-border/70 bg-card p-6">
                <IconSquare icon={Building2} />
                <h2 className={cn(H2, 'mt-5 mb-1')}>Create a team</h2>
                <p className={cn(BODY_MUTED, 'mb-6')}>
                  Give your team a name. You can invite reps after it&apos;s
                  created.
                </p>
                <CreateForm />
              </div>
          ...
          {mode === 'join' && (
            <div className="max-w-md">
              ...
              <div className="rounded-xl border border-border/70 bg-card p-6">
                <IconSquare icon={Hash} />
                <h2 className={cn(H2, 'mt-5 mb-1')}>Join a team</h2>
                <p className={cn(BODY_MUTED, 'mb-6')}>
