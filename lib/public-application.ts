...
export const publicApplicationSchema = z.object({
  ...
  currentProviderName: optStr,
  currentProviderPhone: optStr,
  previousProviderName: optStr,
  previousProviderPhone: optStr,
...
export function buildApplicationData(input: PublicApplicationInput) {
  return {
    ...
    currentProviderName: input.currentProviderName,
    currentProviderPhone: input.currentProviderPhone,
    previousProviderName: input.previousProviderName,
    previousProviderPhone: input.previousProviderPhone,
