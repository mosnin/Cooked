 ...
 *   - lead routing / reassignment  → lib/ai-tools/tools/assign-lead-to-rep.ts
 ...
 * Primary CTA stays the locked home pill → /login/rep?intent=signup.
 * Teams want a walkthrough, so "Book a demo" → /demo is prominent.
 */

import { auth } from '@clerk/nextjs/server';
import { redirect } from 'next/navigation';
import { TeamsContent } from '@/components/marketing/teams/teams-content';

export const metadata = { title: 'For teams · Koala' };
