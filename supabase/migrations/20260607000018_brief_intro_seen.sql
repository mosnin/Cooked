-- briefIntroSeenAt — the rep's first-ever brief carries a one-line
...
--
-- Nullable so existing reps who got briefs before this column was
...
-- intro line for ~existing reps~ to avoid backfill complexity.
