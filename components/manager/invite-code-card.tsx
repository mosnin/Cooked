      ...
      <CardContent className="px-5 py-4 space-y-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Share this code — anyone can use it to join as a Rep</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <p className="text-xs text-muted-foreground">No invite code set. Ask the team owner to generate one.</p>
        )}
