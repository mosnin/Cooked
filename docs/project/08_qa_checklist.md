...
## Permissions
- [ ] Each role (Platform Admin, Manager Owner, Manager Manager, Rep Member, Solo Rep) can only access their permitted routes
...
- [ ] Team list shows all teams with details
- [ ] Individual user detail page works
- [ ] Individual team detail page works
