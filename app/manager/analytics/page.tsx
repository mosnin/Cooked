/**
 * /manager/analytics -- Team conversion funnel + per-agent breakdown.
 *
...
export const metadata: Metadata = { title: 'Analytics -- Team' };
      ...
      {isEmpty ? (
        ...
        <div className="rounded-xl border border-dashed border-border/70 bg-muted/20 px-5 py-10 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Lead and deal data across your member reps will appear here.
          </p>
        </div>
      ) : (
