-- Composio trigger subscriptions per rep connection.
--
-- Each row tracks ONE registered Composio trigger for ONE
-- IntegrationConnection. When a rep connects Gmail we register the
...
--             kept as a breadcrumb so the rep isn't silently missing
